...
class AcCartaAval extends Model {
    ...
    protected $fillable = ['id', 'clave', 'cedula_afiliado', 'codigo_contrato', 'fecha_solicitud', 'fecha_emision', 'motivo', 'diagnostico', 'costo_total', 'documentos', 'estatus', 'codigo_proveedor_creador', 'creador', 'telefono', 'rechazo', 'cantidad_servicios', 'tipo_afiliado', 'fecha_autorizacion', 'deleted_at'];
