...
class AcClaveOdontologica extends Model {
    ...
    protected $fillable = ['id', 'clave', 'tipo_control', 'cedula_afiliado', 'codigo_contrato', 'fecha_atencion1', 'fecha_atencion2', 'fecha_atencion3', 'clave_primaria', 'motivo', 'codigo_proveedor_creador', 'estatus', 'creador', 'telefono', 'deleted_at'];
