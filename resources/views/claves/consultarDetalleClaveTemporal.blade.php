@extends('layouts.app')
@section('title','Detalle Clave Temporales')
@section('content') 
<h4>Afiliado</h4>
@if (isset($clave))
  ...
  @endforeach 
    ...
    <div class="form-group">    
      <div class="col-sm-offset-2 col-sm-3">            
          <p><a href="{{ url('claves/pdfDetalleTemporal?id_clave='.$id_clave.'&accion=imprimir') }}"  target="_blank" class="btn btn-primary form-control ">Imprimir</a>
          </p>    
      </div>
        <div class="col-sm-offset-2 col-sm-3"><!--   -->
          <p><a href="{{ url('claves/pdfDetalleTemporal?id_clave='.$id_clave.'&accion=descargar') }}" target="_blank" class="btn btn-primary form-control ">Descargar</a>
          </p>    
        </div>
    </div>
