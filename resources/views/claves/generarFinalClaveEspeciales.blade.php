...
<h4>Datos de la Atención Médica</h4>
    {!! Form::open(['url' => 'clavesEspeciales/procesar', 'class' => 'form-horizontal',
                                                             'id' => 'procesar',
                                                           'name' => 'procesar', 
                                                           'lang' => 'es','files' => 'true', 'data-parsley-validate' => '']) !!}
    <div class="form-group {{ $errors->has('fecha_cita') || $errors->has('telefono') ? 'has-error' : ''}}">
        ...
        <div class="col-sm-3">
            {!! Form::date('fecha_solicitud', null, ['class' => 'form-control input-sm', 'required' => 'required','placeholder' => 'dd-mm-aaaa']) !!}
    ...
    <div class="form-group {{ $errors->has('diagnostico') ? 'has-error' : ''}}">
        {!! Form::label('diagnostico', 'Diagnostico: ', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-8">
    ...
    <div class="form-group">
     {!! Form::label('archivo', 'Archivo: ', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-5">
            {!! Form::file('archivo',['placeholder' => '.doc,.pdf,.jpg','id'=>'archivo']) !!}
...
@section('script')
    <script>
        $(function(){
            $( "#fecha_cita" ).datepicker({ minDate: -5, maxDate: "+5D", dateFormat: "dd-mm-yy" });
            $('#procesar').parsley();
            ...
            $('.btn-add-procedimiento').on('click',function(){
                if($('#codigo_especialidad').val() !== "" && $('#codigo_servicio').val() !== "" && $('#procedimiento_medico').val() !== "" && $('#codigo_proveedor').val() !== ""){
                    ...
                    var proveedor    = "<input type='hidden' value='"+ $('#codigo_proveedor').val() +"' name='id_proveedor" + x +"'>";
                    var detalle      = "<input type='hidden' value='"+ $('#detalle').val() +"' name='detalle" + x +"'>";
                    proveedorX       = $('#codigo_proveedor').val();
                    $('#procedimientos').append("<tr class='fila" + x +"'><td>"+$("#codigo_servicio option:selected").text()+"</td>"+
                                                ...
                                                "<td>"+$("#codigo_proveedor option:selected").text()+"</td>"+
                    ...
                    if($('#codigo_servicio :selected').val() != 2){ // Si no es laboratorio
